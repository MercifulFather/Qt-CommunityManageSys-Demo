...
QString FlatUI::setTextEditQss(QTextEdit *txt, int radius, int borderWidth,
                                  const QString &normalColor,
                                  const QString &focusColor)
{
    QStringList list;
    list.append(QString("QTextEdit{border-style:none;padding:3px;border-radius:%1px;border:%2px solid %3;}")
                .arg(radius).arg(borderWidth).arg(normalColor));
    list.append(QString("QTextEdit:focus{border:%1px solid %2;}")
                .arg(borderWidth).arg(focusColor));
...
QString FlatUI::setDateEditQss(QDateEdit *txt, int radius, int borderWidth,
                                  const QString &normalColor,
                                  const QString &focusColor)
{
    QStringList list;
    list.append(QString("QDateEdit{border-style:none;padding:3px;border-radius:%1px;border:%2px solid %3;}")
                .arg(radius).arg(borderWidth).arg(normalColor));
    list.append(QString("QDateEdit:focus{border:%1px solid %2;}")
                .arg(borderWidth).arg(focusColor));
